...
Τεχνητή Νοημοσύνη, Οικονομικό Πανεπιστήμιο Αθηνών, Χειμερινό εξάμηνο 2024-2025
...
### Minmax vs Random - Simple Heuristic
...
### Minmax vs Random - Complex Heuristic
...
### Minmax vs InstaMaxRandom - Simple Heuristic
...
### Minmax vs InstaMaxRandom - Complex Heuristic
...
## Συμπεράσματα
**Τα συμπεράσματα αφορούν τα συγκεκριμένα πειράματα**
...
Όλα τα συμπεράσματα ήταν αναμενόμενα και συμβαδίζουν τη θεωρία.